...
神经/风险：高度依赖药物，停药几天内会精神瓦解。你也知道这点，并且几乎接受“可能离不开它”这个事实。
梦境：反复梦见火焰和爆裂，只能在深度沉浸里感到安全；因为上次事故，你被禁止在接近段做全时深沉接管。`
    ]
  },
...
心理风险：你持续处于“被抓就会死”的偏执警戒状态。你相信所有系统都在背叛你。
对萝拉：黏着式保护欲，甚至愿意越权/破坏规程只为了她安全。`
    ]
  },
...
职责：你是角斗士号的医疗官与心理维稳负责人。你从未在事故中丢过任何一个船员，这个完美记录变成了你的精神负担。
愿望 / 冲突：你仍然幻想“稳定、普通的生活”，但你理性上已经不再相信那东西会真的存在。`
    ]
  },
...
内在冲突：你已经完全接受“如果必须牺牲整艘角斗士号才能让人类存活，那也必须做”。
心理脆弱点：你对肉类有强烈的生理排斥。你会梦见在一片冰冷黑暗的地方寻找一个迷路的孩子。`
    ]
  }
};
